...
export const CHAPTER_REGISTRY: ChapterMeta[] = [
  ...
  },
  {
    ...
    blurb: "Who we're talking to (Nielsen + 8 personas), the five strategic pillars, and the geographic targeting map (stadiums + Cider Point walls + digital halo).",
    subSectionIds: ["audience", "strategy", "marketing-targeting"],
  },
  {
    id: "ch-product-money",
...
export const SECTION_REGISTRY: SectionMeta[] = [
  { id: "overview",            label: "Overview",         blurb: "What this proposal is and how to read it.",                                  group: "frame" },
  { id: "audience",            label: "Audience",         blurb: "Nielsen composite + the 8-persona breakdown.",                                group: "audience" },
  { id: "strategy",            label: "Strategy",         blurb: "The five strategic pillars holding the plan together.",                       group: "frame" },
  { id: "marketing-targeting", label: "Targeting map",    blurb: "Stadiums (KC home + 15 away) + Cider Point walls + digital halo on the SA map.", group: "frame" },
  { id: "product-cvps",        label: "Product CVPs",     blurb: "8 non-comparable products — 5 of 8 first-in-SA-market.",                       group: "model" },
  { id: "model",               label: "Investment model", blurb: "V2 KCM Digital Mobile model · ARPU R116.51 · self-funding from M10.",         group: "model" },
  { id: "pricing",             label: "Pricing",          blurb: "7 packages + 1 Diaspora travel pack + 5 VAS add-ons — all at ≥50% GM.",     group: "model" },
  { id: "execution-plan",      label: "Plan detail",      blurb: "What R4.5M of marketing executes, line by line (KCM model V2 marketing line).", group: "plan" },
  { id: "sponsors-collab",     label: "Sponsors",         blurb: "Current KC sponsors and how each sits with KC Mobile.",                       group: "channels" },
  { id: "voices-and-players",  label: "Voices & Players", blurb: "KC Legends · current squad · SA football media — three layers of human reach.", group: "channels" },
  { id: "ideas",               label: "Launch ideas",     blurb: "16 candidate activation mechanics — match-day, retail, CVP-led. KC chooses which actually launch.", group: "channels" },
  { id: "loyalty",             label: "Loyalty",          blurb: "Khosi tier ladder + AmaCoin currency + retention mechanics.",                group: "lifecycle" },
  { id: "customer-journey",    label: "Customer journey", blurb: "1-to-1 lifecycle marketing, powered by Xanite.",                              group: "lifecycle" },
  { id: "retail-future",       label: "Retail futures",   blurb: "Prospective Year-2 retail partnerships (PEP / Shoprite explored).",            group: "ops" },
  { id: "timing",              label: "Phasing",          blurb: "M-2 waitlist → 12-month rhythm → 6-month launch timeline → tribal phasing.",   group: "phasing" },
];
